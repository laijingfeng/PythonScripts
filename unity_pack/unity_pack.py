...
class MainClass(object):
    ...
    def work(self):
        ...
        do real work
        """
        SvnHelperTortoise.update(self.config['project_path'])
        
        arr = []
        arr.append(self.config['unity_path'])
        arr.append('-projectPath')
        arr.append(self.config['project_path'])
        arr.append('-executeMethod')
        arr.append(self.config['table_method'])
        arr.append('AutoBuildPath-' + self.get_exe_path('./'))
        arr.append('-batchmode')
        arr.append('-quit')
        MainClass.execute_shell_command(arr)
        ...
        arr.append(self.config['project_path'])
        arr.append('-executeMethod')
        arr.append(self.config['res_method'])
        arr.append('AutoBuildPath-' + self.get_exe_path('./'))
        arr.append('-batchmode')
        arr.append('-quit')
        MainClass.execute_shell_command(arr)
